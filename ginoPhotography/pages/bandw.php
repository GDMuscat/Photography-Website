    ...
    <div class="container-fluid mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                ...
                <img src="https://mdbootstrap.com/img/Photos/Slides/img%20(137).jpg" class="img-fluid z-depth-1"
                    alt="Responsive image" data-toggle="modal" data-target="#myModal1">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12 mb-3">
                ...
                <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/6-col/img(115).jpg"
                    class="img-fluid z-depth-1" alt="Responsive image" data-toggle="modal" data-target="#myModal2">
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                ...
                <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/6-col/img(116).jpg"
                    class="img-fluid z-depth-1" alt="Responsive image" data-toggle="modal" data-target="#myModal3">
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                ...
                <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/6-col/img(117).jpg"
                    class="img-fluid z-depth-1" alt="Responsive image" data-toggle="modal" data-target="#myModal4">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <img src="https://mdbootstrap.com/img/Photos/Horizontal/People/6-col/img(117).jpg"
                    class="img-fluid z-depth-1" alt="Responsive image" data-toggle="modal" data-target="#myModal5">
            </div>

            <!-- Grid column 6 -->
            <div class="col-md-6 mb-3">

                <img src="https://mdbootstrap.com/img/Photos/Horizontal/People/6-col/img(129).jpg"
                    class="img-fluid z-depth-1" alt="Responsive image" data-toggle="modal" data-target="#myModal6">
            </div>
        </div>
        ...
        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/6-col/img(115).jpg" alt=""
                            class="img-fluid">
                    </div>
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-default btn-prev">Prev</button>
        ...
        <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/6-col/img(116).jpg" alt=""
                            class="img-fluid">
                    </div>
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-default btn-prev">Prev</button>
